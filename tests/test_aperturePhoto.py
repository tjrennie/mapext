...
def point_source_with_background_wcs():
    ...
    simmap.add_simulation_component(pointSource(I=10/4.5, Q=4/4.5, U=2/4.5, fwhm_deg=2 / 60))
...
def test_photometry_apertureannulus(point_source_with_background_wcs):
    ...
    res = apertureAnnulus(point_source_with_background_wcs, s, result_to_src=False, return_results=True, plot=False)
